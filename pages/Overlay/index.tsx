...
const Overlay = () => {
    return (
        <>
        <button className="open" style={{"zIndex":5}}><i className="fa-solid fa-caret-right"></i></button>
        <div className="btn-box fl-row" style={{"zIndex":5}}>
        ...
        <div className="left-box fl-col" style={{"zIndex":5}}>
            <div className="item it-1">
                <div className="cont fl-col">
                    <div className="tit fl-row">
                        <div>메인정보</div>
                    </div>
                    <div className="info-box fl-col">
                        <div className="info fl-row">
                            <div>
                                {/* <img src="assets/images/clock.svg" alt="시간"/> */}
                                <img src='/public/images/clock.svg' alt="시간"/>
                            </div>
                            <div className="num fl-col">
                                <div>날짜/시간</div>
                                <div className="icon fl-row">
                                    <div className="one date fl-row">
                                        <div><img src="/public/images/clock.svg" alt=""/></div>
                                        <div>
                                            <input type="date" value=""/>
                                        </div>
                                    </div>
                                    <div className="two date fl-row">
                                        <div><img src="/public/images/calendar.svg" alt=""/></div>
                                        <div>
                                            <input type="date" value=""/>
                                        </div>
                                    </div>
                        ...
                        <div className="info fl-row">
                            <div><img src="/public/images/sun.svg" alt=""/></div>
                            <div className="num fl-col">
                                <div>날씨</div>
                                <div className="cloud">구름많음(낮)</div>
                            </div>
                        </div>
                        <div className="info fl-row">
                            <div><img src="/public/images/temperature.svg" alt=""/></div>
                        <div className="num fl-col">
                            <div>온도/습도</div>
                            <div className="icon fl-row">
                                <div className="one temp fl-row">
                        ...
                        <div className="info fl-row">
                            <div><img src="/public/images/play.svg" alt="시간"/></div>
                            <div className="num fl-col">
                                <div>날짜/시간</div>
                                <div className="loading-bar-container">
                                    <span className="loading-bar-outer-text"></span>
            ...
            <div className="item it-2">
                <div className="cont fl-col">
                    <div className="tit fl-row">
                        <div className="ttt">주간일사량</div>
                        <div className="val fl-row">
                            <div className="ddd one">경사일사량</div>
                            <div className="ddd two">수평일사량</div>
                        </div>
                    </div>
            ...
            <div className="item it-3">
                <div className="cont fl-col">
                    ...
                    <div className="tab-list fl-row">
                        <div className="tab">일간</div>
                        <div className="tab">주간</div>
                        <div className="tab">월간</div>
                        <div className="tab">누적</div>
                    </div>
                    <div className="tab-cont">
                        <div className="tcon">
                            <div className="sbox fl-col">
                                <div className="gr"><canvas id="dailyPowerGeneration" width="400px;" height="300px;"/></div>
                                <div className="detail fl-row">
                                    <div className="inf">
                                        <p>전일발전량</p>
                        ...
                        <div className="tcon">
                            <div className="sbox fl-col">
                                <div className="gr"><canvas id="weeklyPowerGeneration" width="400px;" height="300px;"/></div>
                                <div className="detail fl-row">
                                    <div className="inf">
                                        <p>전일발전량</p>
                                        <p>2300.5 kwh</p>
                    ...
                    <div className="tcon">
                        <div className="sbox fl-col">
                            <div className="gr"><canvas id="monthlyPowerGeneration" width="400px;" height="300px;"/></div>
                            <div className="detail fl-row">
                                <div className="inf">
                                    <p>전일발전량</p>
                                    <p>2340.2 kwh</p>
                        ...
                        <div className="tcon">
                            <div className="sbox fl-col">
                                <div className="gr" ><canvas id="accumulatePowerGeneration" width="400px;" height="300px;"/></div>
                                <div className="detail fl-row">
                                    <div className="inf">
                                        <p>전일발전량</p>
                                        <p>2332.2 kwh</p>
        ...
        <div className="right-box fl-col" style={{"zIndex":5}}>
            <div className="item it-4">
                <div className="cont fl-col">
                    <div className="tit fl-row">
                        <div>출력량</div>
                        <div className="dat">지난6개월<i className="fa-solid fa-chevron-down"></i></div>
                    </div>
            ...
            <div className="item it-6">
                <div className="cont fl-col">
                    <div className="tit fl-row">
                        <div>운구량 & 강수량 월별추이 </div>
                        <div className="val fl-row">
                            <div className="ddd one">강수량</div>
                            <div className="ddd two">운구량</div>
                        </div>
                        <div className="dat">월간 <i className="fa-solid fa-chevron-down"></i></div>
                    </div>
